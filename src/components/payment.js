            ...
            <div class="container py-5">
                ...
                <div class="row mb-4">
                    <div class="col-lg-8 mx-auto text-center">
                        <h1 class="display"> Payment Form</h1>
                    </div>
                </div>
                <div class="row">
                            ...
                            <div class="card-header">
                                ...
                                <div class="tab-content">
                                    <div id="credit-card" class="tab-pane fade show active pt-3">
                                        <form role="form" className='payform' onsubmit="event.preventDefault()">
                                            ...
                                            <div class="card-footer"> <button type="button" onClick={() => { alert("Payment successfull") }} class="subscribe btn btn-primary btn-block shadow-sm"><NavLink to="/thank"></NavLink> Confirm Payment </button></div>
                                        </form>
                                    </div>
                                    ...
                                    <div id="net-banking" class="tab-pane fade pt-3">
                                        ...
                                        <div class="form-group">
                                            <p> <button type="button" class="btn btn-primary "><i class="fa fa-mobile-alt mr-2"></i> Proceed Payment</button> </p>
                                        </div>
                                        <p class="text-muted">Note: After clicking on the button, you will be directed to a secure gateway for payment. After completing the payment process, you will be redirected back to the website to view details of your order. </p>
                                    </div>
                                </div>
